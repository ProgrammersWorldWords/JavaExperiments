/*
	Write a program in java to perform Menu Driven Arithmetic operations.
	Author : Abdul Muttalib Shaikh
*/

import java.io.*;
import java.util.*; // both are pakages
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println("\t 6. Exit \n");
 		...
 		do{
		   ...
		   switch (choice){ 
				   case 1: 
                                   System.out.print("Input through DataInputStream :\n\n");
				   ...
				   case 2 : 
                                   System.out.print("Input through Scanner :\n\n");
   				   System.out.print("Enter First Number :");
                                   x =sc.nextInt();
                                   System.out.print("Enter Second Number :");
                                   y =sc.nextInt();
                                   ...
                                   case 3 : 
                                   System.out.print("Input through BufferedReader :\n\n");
                                   System.out.print("Enter First Number :"); 
